# Security Policy - phenotype-registry
...
If you discover a security vulnerability in `phenotype-registry`, please report it privately:
...
In scope:
- The `phenotype-registry` source tree on the default branch
