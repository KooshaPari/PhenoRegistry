...
"""
pheno-framework-lint: ADR-042 substrate graduation & tier-convention linter (L73).

Enforces the 4 substrate-tier conventions from ADR-042 / AGENTS.md:
...
# ---------------------------------------------------------------------------
# Tier definitions (ADR-042 §2, AGENTS.md "App substrate placement")
# ---------------------------------------------------------------------------
