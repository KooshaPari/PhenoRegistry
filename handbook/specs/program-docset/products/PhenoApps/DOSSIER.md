...
# PhenoApps: role-specific atlas and qualification

**Role:** Possible bounded application collection. **Class:** conditional-target. **Repository ID:** 1272990345.
...
Resolve the actual FocalPoint application source, Localbase and RIPFitnessApp future disposition separately. A shared repository must not force a shared product, database or release lifecycle.
...
Use package/workspace boundaries, native application frameworks and mature domain facilities.
...
Each accepted app remains independently installable, testable and understandable; no archive or donor deletion follows from this dossier.
