...
# PhenoAI: role-specific atlas and qualification

**Role:** AI/framework/device capability collection pending consolidation. **Class:** pooled-foundation. **Repository ID:** 1201987910.
...
Identify embeddings, providers, agent SDK, device drivers and artifact contracts independently. Resolve which consumers require each package and distinguish Agentora from similarly named CLI frameworks.
...
Prefer established SDKs, framework adapters and provider clients; maintain narrow owned policy and unsupported capability deltas.
...
Each retained package has a clean consumer, truthful support profile and an adopt/patch/wrap/retain decision backed by tests.
