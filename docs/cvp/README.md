...
A CVP is _not_ an MVP. MVPs optimize for "ship something to validate demand".
...
version that best expresses _what this product is at its core_.
...
- When explaining to a new contributor what the project actually _is_.
...
<One paragraph: what this product _is_, stated as a noun not a feature list.>
