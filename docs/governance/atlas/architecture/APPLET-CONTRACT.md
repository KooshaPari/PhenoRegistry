...
## Revision 1.3 — reciprocal installed-application experience

The [reciprocal federation contract](../federation/README.md) supplies the previously missing co-install discovery, host-relative presentation, native contribution, automatic setup, scoped consent, lifecycle/recovery and optional App Center requirements. This file remains the conceptual applet boundary; the new profile does not reinterpret old free-text policies as executable permission. See [ADR-014](../adr/ADR-014.md).
