...
## Revision 1.3 federation requirements

The 56 proposed FED-* requirements are [listed here](federation/REQUIREMENTS.md) and included in records/requirements.json with bidirectional work/intent/spec links. They are not implementation evidence.
