...
| ---- | ------ | ---- | --- |
| ? | claude-code | `docs/curated-prompts/claude-code/unknown/fff6512b8510cad5.md` | policy-setting |
| ? | claude-code | `docs/curated-prompts/claude-code/unknown/9793ec15e7e165d6.md` | policy-setting |
| ? | claude-code | `docs/curated-prompts/claude-code/unknown/21ba52699f62c533.md` | policy-setting |
| ? | ? | `fc4166d23c49847c.md` (not rendered) | ? |
...
See: [`docs/boundary/phenotype-terrain.md`](../boundary/phenotype-terrain.md)
