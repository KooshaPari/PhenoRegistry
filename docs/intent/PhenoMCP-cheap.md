...
| ---- | ------ | ---- | --- |
| ? | claude-code | `docs/curated-prompts/claude-code/unknown/bc92ba287fb01391.md` | repo-defining |
...
See: [`docs/boundary/PhenoMCP-cheap.md`](../boundary/PhenoMCP-cheap.md)
