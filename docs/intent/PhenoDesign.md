...
The **asset render pipeline** (Blender, FFmpeg, ImageMagick, Unreal) lives in the peer repo [`<REDACTED>/asset-engine`](https://github.com/<REDACTED>/asset-engine), extracted from the former `engine/` subtree (2026-07-20).
